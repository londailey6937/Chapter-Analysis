...
export const CONCEPT_LIBRARIES: Record<Domain, ConceptLibrary> = {
  ...
  computing: {
    ...
    concepts: [
      ...
      {
        name: "function",
        aliases: ["method", "procedure", "subroutine", "functions", "methods"],
        category: "Programming Fundamentals",
        subcategory: "Core Concepts",
        importance: "core",
      },
      ...
      {
        name: "loop",
        aliases: ["loops", "iteration", "for loop", "while loop", "do-while"],
        category: "Programming Fundamentals",
        subcategory: "Core Concepts",
        importance: "core",
      },
      {
        name: "conditional",
        aliases: ["conditionals", "if statement", "if-else", "switch", "case"],
        category: "Programming Fundamentals",
        subcategory: "Core Concepts",
        importance: "core",
      },
